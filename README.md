...
**Blog App** is an online content management system which enables its users to write, like, comment on blog with time-stamped entries. 
...
```
git clone https://github.com/AdnanOlarmmi/Blog-App.git
```
